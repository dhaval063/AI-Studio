...
export default function PlatesSKUView({ onOpenQuoteModal, onBackToCatalog }: PlatesSKUViewProps) {
  ...
  const getWhatsAppLink = (customText?: string) => {
    const text = customText || `Hello Namya EcoPack Export Team, I am interested in your Sugarcane Plates range (6" to 12" Round Plates). Please share wholesale MOQ terms, B2B price lists, and container shipping schedules to our region.`;
      ...
      <section className="bg-teal-950 text-white rounded-3xl p-8 lg:p-12 text-center space-y-6 relative overflow-hidden">
        ...
        <div className="max-w-3xl mx-auto space-y-4 relative z-10">
          ...
          <div className="flex flex-wrap justify-center gap-4 pt-4">
            ...
            <a
              href={getWhatsAppLink("Hello Namya EcoPack Export Team, I would like to contact your sales representative regarding your Sugarcane Plates range.")}
              target="_blank"
              rel="noopener noreferrer"
