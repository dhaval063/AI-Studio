...
import { ArrowLeft, MessageCircle, FileText, CheckCircle, HelpCircle, X, ChevronRight, Grid3X3, ShieldCheck, Layers, Minimize } from 'lucide-react';
          ...
          {traySkus.map((sku) => {
            return (
              ...
              >
                ...
                {/* SVG Compartments Visual representation */}
