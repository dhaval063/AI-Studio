    ...
    <>
      ...
      <div className="fixed bottom-6 right-6 z-40 flex flex-col space-y-3">
        ...
        <motion.button
          ...
          className="bg-[#25D366] text-white p-3.5 rounded-full shadow-2xl hover:bg-[#20ba59] transition-all duration-200 flex items-center justify-center relative group"
          title="Chat with export manager on WhatsApp"
        >
          {/* Custom brand-accurate SVG for WhatsApp */}
          <svg 
